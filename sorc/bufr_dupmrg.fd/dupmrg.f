...
C   PRGMMR: KEYSER           ORG: NP22        DATE: 2013-01-14
C
...
C-----------------------------------------------------------------------
C-----------------------------------------------------------------------
      CALL W3TAGB('BUFR_DUPMRG',2013,0014,0062,'NP22')
 
      print *
      print * ,'---> Welcome to BUFR_DUPMRG - Version 01-14-2013'
      print *
